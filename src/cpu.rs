...
impl<'a> Cpu<'a> {
    ...
    fn extended_opcodes(&mut self) {
        ...
        match instr {
            ...
            0x26 => ops::sla_at_address(self.mem, pack_u16(h, l), &mut self.reg.f), // SLA (HL) 
            ...
            0x2E => ops::sra_at_address(self.mem, pack_u16(h, l), &mut self.reg.f), // SRA (HL) 
            ...
            0x36 => ops::swap_at_address(self.mem, pack_u16(h, l), &mut self.reg.f), // SLA (HL) 
            ...
            0x3E => ops::srl_at_address(self.mem, pack_u16(h, l), &mut self.reg.f), // SRA (HL) 
