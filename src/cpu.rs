...
impl<'a> Cpu<'a> {
    ...
    pub fn tick(&mut self) {
        ...
        match instr {
            ...
            0x27 => panic!("DAA instruction not implemented and is being used"),
            0x28 => opcode!(ops::relative_jmp_by_signed_immediate_if_true(&mut *self.mem, &mut self.reg.pc, zero), "JR Z, n", self),
            ...
            0x30 => opcode!(ops::relative_jmp_by_signed_immediate_if_true(&mut *self.mem, &mut self.reg.pc, no_carry), "JR NC, n", self),
            ...
            0x38 => opcode!(ops::relative_jmp_by_signed_immediate_if_true(&mut *self.mem, &mut self.reg.pc, carry), "JR C, n", self),
            ...
            0xE8 => opcode!(panic!("Not Implemented"), "ADD SP, (signed)n", self),
            ...
            0xF2 => panic!("Not Implemented"),
            0xF3 => opcode!(ops::disable_interrupts(&mut self.reg.ime), "DI", self),
            0xF4 => panic!("Not Implemented"),
            0xF5 => opcode!(ops::push(&mut *self.mem, &mut self.reg.sp, pack_u16(a, f)), "PUSH AF ", self),
            0xF6 => panic!("Not Implemented"),
            0xF7 => panic!("Not Implemented"),
            0xF8 => panic!("Not Implemented"),
            0xF9 => panic!("Not Implemented"),
            ...
            0xFC => panic!("Not Implemented"),
            0xFD => panic!("Not Implemented"),
